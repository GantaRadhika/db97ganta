...
async function recreateDB(){ 
  ...
  let instance1 = new Eggfry({Onions:10, spices:"low",curry:"omlete"});
  let instance2 = new Eggfry({Onions:2, spices:"medium",curry:"eggburji"});
  let instance3 = new Eggfry({Onions:3, spices: "high",curry:"eggtikka"});
